...
public abstract class Hero extends DungeonCharacter implements SpecialMove
{
	protected double chanceToBlock;
	protected int numTurns;
	protected int numHealPotions;
...
---------------------------------------------------------*/
	...
	{
		if(this.numHealPotions > 0)
		{
		int healthGiven;
		healthGiven = (int)(Math.random() * 10) + 5;
		this.addHitPoints(healthGiven);
		System.out.println("The Hero Uses A Health Potion And Gains "+ healthGiven + " HealthPoints");
		this.numHealPotions--;
		}
		else
		{
			System.out.println("You Do Not Have Any More Potions");
		}
	}
}//end Hero class